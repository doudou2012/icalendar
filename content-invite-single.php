    ...
    <header class="entry-header">
        ...
        <div class="all-sorts-of-meta">
            <ul class="list-inline">
                <li>时间：<?=$date?></li>
                <li>邀请人：<?=$current_user->login?> <?=$current_user->user_login?></li>
            </ul>
            <button class="btn btn-default btn-not-rounded btn-sm" id="detailTrigger" onclick="showHideEventDetail()">展览详情 <span class="caret"></span></button>
        </div>
        </header><!-- .entry-header -->
