...
//        $showBullet = wp_is_mobile()?false:true;
	...
	<div class="entry-content">
        ...
        <div class="btn-container">
            <button class="btn btn-block btn-lg btn-info btn-not-rounded" <?= $isFav ? ' disabled="disabled" ':'id="add_fav"'?> ><i class="glyphicon <?= $isFav ? ' glyphicon-heart' : ' glyphicon-heart-empty' ?>"></i> 感兴趣</button>
