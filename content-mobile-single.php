...
//        $showBullet = wp_is_mobile()?false:true;
	...
	<div class="entry-content">
        ...
        <div class="btn-container">
            <button class="btn btn-block btn-lg btn-info btn-not-rounded color-red" id="add_fav" ><i class="glyphicon <?= $isFav ? 'glyphicon-heart' : 'glyphicon-heart-empty' ?>"></i> 想去</button>
            <button class="btn btn-block btn-lg btn-info btn-not-rounded color-red" id="invite-friends"><i class="glyphicon glyphicon-share-alt"></i> 邀请好友</button>
        </div>
        </div>
        <?php endif;?>
        <h2>展览信息</h2>
